...
class Test_Dataset(data.Dataset):
    def __init__(self, data_root, trainsize):
        self.trainsize = trainsize
        if 'DUTS' in data_root:
            image_root = os.path.join(data_root, 'images/')
            gt_root = os.path.join(data_root, 'gt/')
        elif 'COD10K' in data_root:
            image_root = os.path.join(data_root, 'Imgs/')
            gt_root = os.path.join(data_root, 'GT/')
        elif 'SBU' in data_root:
            image_root = os.path.join(data_root, 'Image/')
            gt_root = os.path.join(data_root, 'Mask/')
        elif 'Trans10K' in data_root:
            image_root = os.path.join(data_root, 'images/')
            gt_root = os.path.join(data_root, 'mask_binary/')
        elif 'polyp' in data_root:
            image_root = os.path.join(data_root, 'images/')
            gt_root = os.path.join(data_root, 'masks/')
        elif 'COVID' in data_root:
            image_root = os.path.join(data_root, 'images/')
            gt_root = os.path.join(data_root, 'masks/')
        elif 'breast' in data_root:
            image_root = os.path.join(data_root, 'images/')
            gt_root = os.path.join(data_root, 'masks/')
        elif 'isic2018' in data_root:
            image_root = os.path.join(data_root, 'images/')
            gt_root = os.path.join(data_root, 'masks/')
        else:
            image_root = os.path.join(data_root, 'images/')
